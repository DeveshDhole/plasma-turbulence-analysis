...
threshold = np.quantile(J_squared, 0.9)
...
plt.ylabel(r'$y/d_p$')
plt.tight_layout()
plt.savefig("J2_with_CS_contours.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("J2_maxima_overlay.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("J2_M1_Histogram.png", dpi=300)
plt.show()    
...
plt.legend()
plt.tight_layout()
plt.savefig("J2_M1_PDF.png", dpi=300)
plt.show()
...
# --- Save clean figure ---
plt.tight_layout()
plt.savefig("J2_Descent_Direction.png", dpi=300)
plt.show()
...
plt.tight_layout()
plt.savefig("J2_M2_Histogram.png", dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("J2_M2_PDF.png", dpi=300)
plt.show()
...
plt.ylabel("Count")
plt.savefig("J2_M3_Histogram.png", dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("J2_M3_PDF.png", dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("J2_M4_maxima_overlay.png", dpi=300)
plt.show()
...
# --- Save clean figure ---
plt.tight_layout()
plt.savefig("J2_M4_Descent_Direction.png", dpi=300)
...
plt.title('Histogram of total distances from maxima to region boundaries')
plt.tight_layout()
plt.savefig("J2_M4_Histogram.png", dpi=300)
plt.show()
...
plt.legend()
plt.tight_layout()
plt.savefig("J2_M4_PDF.png", dpi=300)
plt.show()
...
#Compare Histograms of Method 1, Method 2, Method 3 and Method 4

plt.figure(figsize=(8, 6))

bins = 50  # same bins for both

plt.hist(thicknesses_m1, bins=bins, alpha=0.6, label='Thicknesses Method 1',
         color='darkorange', edgecolor='black', density=True)

plt.hist(thicknesses_m2, bins=bins, alpha=0.6, label='Thicknesses Method 2',
         color='dodgerblue', edgecolor='black', density=True)

plt.hist(thicknesses_m3, bins=bins, alpha=0.6, label='Thicknesses Method 3',
         color='seagreen', edgecolor='black', density=True)

plt.hist(thicknesses_m4, bins=bins, alpha=0.6, label='Thicknesses Method 4',
         color='mediumorchid', edgecolor='black', density=True)


plt.xlabel('Value (pixels)')
plt.ylabel('Probability density')
plt.title('Comparison of Thicknesses')
plt.legend()
plt.tight_layout()
plt.savefig("J2_Histogram.png", dpi=300)
plt.show()
...
#Compare PDFs of Method 1, Method 2, Method 3 and Method 4

plt.figure(figsize=(8, 6))

sns.kdeplot(thicknesses_m1, color='darkorange', label='Method 1 KDE', linewidth=2)
sns.kdeplot(thicknesses_m2, color='dodgerblue', label='Method 2 KDE', linewidth=2)
sns.kdeplot(thicknesses_m3, color='seagreen', label='Method 3 KDE', linewidth=2)
sns.kdeplot(thicknesses_m4, color='mediumorchid', label='Method 4 KDE', linewidth=2)


plt.xlabel('Value (pixels)')
plt.ylabel('Probability density')
plt.title('Comparison of Thicknesses with KDE')
plt.legend()
plt.tight_layout()
plt.savefig("J2_PDF.png", dpi=300)
plt.show()
